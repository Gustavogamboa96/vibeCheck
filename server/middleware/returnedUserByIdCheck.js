...
async function checkReturnedUser(req, res, next) {
    const data = {};
    ...
    if (returnedUser.Count === 0 || returnedUser.Count > 1 || userData.email !== returnedUser.Items[0].email || userData.username !== returnedUser.Items[0].username) {
...
module.exports = { checkReturnedUser }